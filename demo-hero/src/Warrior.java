...
public class Warrior extends Hero {
  ...
  public boolean weaponLevelup(){
    return super.getWeapon().levelUp();
  }

  public int physicalAttack(){
    int totalDamage = super.getWeapon().getPhysicalAttack() + Warrior.levelValue[super.getLevel() - 1][2];

    System.out.println("Your " + this.getClass().getName() 
    + " use " + super.getWeapon().getName() 
    + " to PhysicalAttack, total damage is " + totalDamage + ".");
    return totalDamage;
  }

  public int magicalAttack(){
    int totalDamage = super.getWeapon().getMagicalAttack() + Warrior.levelValue[super.getLevel() - 1][4];
  ...
  public static void main(String[] args) {
    ...
    w1.equipWeapon(WeaponName.Hexdrinker,1);
